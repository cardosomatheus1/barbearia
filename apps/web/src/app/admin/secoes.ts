...
export const MODULOS = [
  ...
  },
  {
    ...
    nome: 'Agenda',
    telas: [
      { href: '/admin/agenda', nome: 'Agenda', secao: 'agenda', molde: 'operacional', nota: 'marcar, remarcar e bloquear folga ou férias', busca: 'ferias folga ausencia bloqueio atestado remarcar', permissao: ['appointments.view'] },
  ...
  },
  {
    ...
    telas: [
      ...
      { href: '/admin/profissionais', nome: 'Profissionais', secao: 'profissionais', molde: 'cadastro', nota: 'barbeiros, jornada semanal e metas', grupo: 'Quem atende, e com o quê', busca: 'equipe barbeiro escala jornada meta comissao', permissao: ['settings.manage'] },
  ...
  },
  {
    ...
    telas: [
      ...
      { href: '/admin/configuracoes', nome: 'Horários e regras', secao: 'configuracoes', molde: 'configuracao', nota: 'funcionamento, feriados e políticas de cancelamento', grupo: 'Negócio', busca: 'horario funcionamento abre fecha feriado politica cancelamento antecedencia endereco', permissao: ['settings.manage'] },
    ],
