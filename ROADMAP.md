...
| Split de pagamento exercido pelo adquirente | a modelagem inteira (bloco 49): `payment_splits` com estado por parte, a derivação **da comissão** dentro da transação que confirma o pagamento, a soma conferida ao centavo, o interruptor por barbearia e a alíquota da plataforma em `tenant_platform`, escrita só pelo Super Admin | a chamada de split **de verdade** ao adquirente, e o cadastro de recebedor (KYC) de cada profissional. Hoje as partes são calculadas e registradas, e o dinheiro cai inteiro na conta da barbearia — a parte do profissional fica `pendente` e o acerto sai no fechamento, como sempre saiu | 50 (KYC do profissional, liquidação e estorno), que é o bloco seguinte e o que fecha esta ponta |
