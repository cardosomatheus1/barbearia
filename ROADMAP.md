...
| O peso da assinatura no score da fila de espera | o score da SPEC §2.9 inteiro, com os cinco termos escritos, testados e pesando o que o texto manda — e o convite saindo sozinho, com dez minutos de exclusividade e o horário segurado | o termo `assinante`, que hoje entra **constante e falso** para todo mundo, porque não existe assinatura no produto. Constante, ele não altera a ordem de ninguém: o efeito é o score inteiro caber em 0,8 | 45 (assinatura recorrente), que é onde o fato nasce. Ligá-lo antes seria premiar um estado que ninguém consegue ter — e o motor já lê o campo, então o bloco 45 preenche a origem e nada mais |
