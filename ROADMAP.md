...
| Aviso automático da vaga, com ordem por score e janela exclusiva | a lista existe, expira sozinha, fecha quando o cliente consegue marcar, e o cancelamento devolve **quem quer a vaga** dentro da própria transação — nas duas portas, a do cliente e a do balcão. A ordem é a de entrada na fila, que é o décimo do score da SPEC §2.9 | os outros noventa por cento do score (aderência do horário, recorrência histórica, assinatura ativa, confiabilidade), a janela exclusiva de dez minutos e o aviso saindo sozinho. Hoje a barbearia lê a lista e liga | 39, que é o bloco seguinte e existe para isso. O aviso automático depende também do canal: até o WhatsApp oficial entrar (bloco 55), o que sai é o provedor de console |
