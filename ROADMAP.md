...
| Recurso ligado ou desligado por plano | o recurso é por barbearia, com padrão de catálogo e exceção auditada; o plano tem teto de cadeiras | amarrar recurso a plano, para que "Essencial" e "Completo" signifiquem coisas diferentes | 27 (billing: planos, trial, assinatura): que recurso cada plano dá é decisão de oferta comercial, e ela não existe até haver cobrança. Amarrar agora congelaria uma tabela de preços que ninguém desenhou |
