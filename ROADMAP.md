...
| Aviso de retenção por mensagem ao dono | a varredura carimba quem está para sair, e a tela de privacidade lista nome por nome com quantos dias faltam — o aviso prévio da SPEC §1.8 regra 6, no canal que o dono de fato abre | mandar o aviso ativamente, por WhatsApp ou e-mail, para quem não abriu a tela em trinta dias | 33 (segurança: hardening, auditoria de acesso): é o mesmo canal e a mesma decisão de produto do alerta operacional — o que merece interromper o dono e com que frequência — e cabe junto da tela de preferências de notificação do gestor, que é do mesmo bloco. Enquanto isso o prazo é de trinta dias e a lista está sempre à mão |
