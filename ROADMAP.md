...
| Trocar de plano pelo autoatendimento | o plano é trocado pela plataforma, com o preço recopiado, o teto conferido nos dois sentidos e rastro do de-para; o dono vê o próprio plano, o prazo do teste e o que vem junto | o botão do lado do dono, e o rateio proporcional que ele exige | 28 (billing: upgrade/downgrade, inadimplência): mudar de faixa no meio do período muda quanto se cobra, e um botão sem essa conta cobraria mês cheio por meio mês. Mostrar o botão antes da conta seria prometer o que não se entrega |
| Fatura, cobrança e a régua de vencimento | a assinatura tem estado, período, preço contratado e `past_due` no vocabulário; a lista da plataforma sai ordenada por quem vence primeiro | a fatura em si, o aviso antes do vencimento e a régua de retentativa | 28 (billing: upgrade/downgrade, inadimplência, régua de retentativa): é o bloco seguinte, e o que este entregou é o estado sobre o qual ele opera |
