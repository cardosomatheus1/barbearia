...
export function falhasDaCriptografiaDeBackup(fontes={}){
  ...
  if(!backup.includes('BACKUP_ENCRYPTION_KEY ausente') || !backup.includes('backup-crypto.mjs" encrypt') || !backup.includes('backup-crypto.mjs" check')) f.push('backup não falha fechado e/ou não valida artefato cifrado');
